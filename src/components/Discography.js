function Discography() {
    return [
        ...
        },
        {
            ...
            date: 'Released 1978',
            content: "The Man-Machine (German: Die Mensch-Maschine) is the seventh studio album by German electronic music band Kraftwerk. It was released on 19 May 1978 by Kling Klang in Germany and by Capitol Records elsewhere. A further refinement of their mechanical style, the album saw the group incorporate more danceable rhythms. It includes the singles 'The Model' and 'The Robots'. Although the album was initially unsuccessful on the UK Albums Chart, it reached a new peak position of number nine in February 1982, becoming the band's second highest-peaking album in the United Kingdom after Autobahn(1974).",
            imgUrl: 'https://images-na.ssl-images-amazon.com/images/I/71TvZE5f%2BnL._SL1417_.jpg',
            review: [],
        },
        {
            id: 5,
            ...
            date: 'Released 1981',
            content: "Computer World (German:Computerwelt) is the eighth studio album by German electronic band Kraftwerk, released on 10 May 1981.The album deals with the themes of the rise of computers within society. In keeping with the album's concept, Kraftwerk showcased their music on an ambitious world tour. The compositions are credited to Ralf Hütter,Florian Schneider, and karl Bartos. As was the case with the two previous albums, Computer World was released in both German- and English-language editions. The cover shows a computer terminal (apparently based on one made by the Hazeltine Corporation displaying the heads of the four band members.",
            imgUrl: 'https://m.media-amazon.com/images/I/81kKLPy6YlS._SL1500_.jpg',
            review: [],
        },
        {
            id: 6,
